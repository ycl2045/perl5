...
"x86_64-linux-3.19.0-20-generic" or
	die "Errno architecture (x86_64-linux-3.19.0-20-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
